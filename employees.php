...
<div class="w3-main" style="margin-left:300px">
  ...
  <div class="w3-container w3-light-grey w3-padding-32 w3-padding-large" id="contact">
    <div class="w3-content" style="max-width:600px">
      <h4 class="w3-center"><b>EMPLOYEES INFORMATION</b></h4>
      <br>
		<form action = "../work/employees.php" method = "GET" target="_self">
        ...
        <button type="submit" class="w3-button w3-block w3-black w3-margin-bottom">Serach</button>
	<br>
	</form>	
<html>
<style>
...
$sql = "SELECT * FROM Emp_info where Department_id like '%".$_GET["Department"]."%'"; 
$ch = $_GET["Department"];
if ( $ch == 'ALL'){
...
if ($result->num_rows > 0) {
			...
			echo '<table><tr><td>Emp_id</td><td>Name</td><td>Age</td><td>Country</td><td>Position</td><td>ID_cardard</td><td>Department_id</td><tr>';
