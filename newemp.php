...
<div class="w3-main" style="margin-left:200px">
  ...
  <div class="w3-container w3-light-grey w3-padding-32 w3-padding-large" id="contact">
    <div class="w3-content" style="max-width:600px">
      <h4 class="w3-center"><b>NEW EMPLOYEES OF DEPARTMENT</b></h4>
	  <br>
	   <br>
...
include("connection1.php");
	...
	$sql = "select Department_name,sum(total) as total from Department 
	inner join Requirement on Requirement.Department_id = Department.Department_id
...
?>
        ...
        var options = {
          title: 'Department new Employees',
          is3D: true,
          width: 750,
          height: 750,
        };
